...
class OpenDeepSearchAgent:
    def __init__(
        ...
        self.model = model if model is not None else os.getenv("LITELLM_SEARCH_MODEL_ID", os.getenv("LITELLM_MODEL_ID", "fireworks_ai/accounts/fireworks/models/llama-v3p3-70b-instruct"))
